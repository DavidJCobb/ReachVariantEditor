...
namespace {
   MPObjectTypeDefinition _instances[] = {
      ...
      MPObjectTypeDefinition("Skull",            'weap', "objects/weapons/multiplayer/skull/skull"),
      MPObjectTypeDefinition("Hill Marker",      'bloc', "objects/multi/models/mp_hill_beacon/mp_hill_beacon"),
      MPObjectTypeDefinition("Flag Stand",       'bloc', "objects/multi/models/mp_flag_base/mp_flag_base"),
      MPObjectTypeDefinition("Bomb Plant Point", 'bloc', "objects/multi/models/mp_circle/mp_circle"),
      ...
      MPObjectTypeDefinition("UNSC Data Core", 'weap', "objects/weapons/multiplayer/unsc_data_core/unsc_data_core"), // Boneyard Invasion objective
      MPObjectTypeDefinition("danger_zone", 'bloc', "objects/multi/spawning/danger_zone"), // tag doesn't exist in Forge World as of this writing
      MPObjectTypeDefinition("teleporter_sender", 'bloc'), // tags with this name exist but are distinct from the Forge-placeable teleporters; should try spawning these and see if they work
      ...
      MPObjectTypeDefinition("phantom_device", 'mach', "objects/vehicles/covenant/phantom/phantom"), // not on Forge World, at least pre-Thorage
      ...
      MPObjectTypeDefinition("mp_cinematic_camera", 'scen', "objects/multi/generic/mp_cinematic_camera"), // Initial Loadout Camera?
      MPObjectTypeDefinition("invis_cov_resupply_capsule", 'mach'),
      MPObjectTypeDefinition("Covenant Power Core", 'weap', "objects/weapons/multiplayer/cov_power_module/cov_power_module"), // Spire Invasion objective
      MPObjectTypeDefinition("Fuel Rod Gun", 'weap', "objects/weapons/support_high/flak_cannon/flak_cannon"),
      ...
      MPObjectTypeDefinition("FX (Purple)", 'bloc'),
      MPObjectTypeDefinition("FX (Orange)", 'bloc'),
      MPObjectTypeDefinition("FX (Green)", 'bloc'),
      MPObjectTypeDefinition("ff_grid", 'bloc'), // Forge-placeable Grid? test whether this works
