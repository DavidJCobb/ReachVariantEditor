...
namespace {
   MPIncidentDefinition _instances[] = {
      ...
      MPIncidentDefinition("Announce Game Start (Juggernaut)", "juggernaut_game_start"),
      ...
      MPIncidentDefinition("Announce Game Start (KOTH)", "koth_game_start"),
      ...
      MPIncidentDefinition("Announce Game Start (Oddball)", "ball_game_start"),
      ...
      MPIncidentDefinition("Announce Game Start (Assault)", "assault_game_start"),
      ...
      MPIncidentDefinition("Unused", ""),
      MPIncidentDefinition("Announce Game Start (Territories)", "terr_game_start"),
      ...
      MPIncidentDefinition("Announce Game Start (Race)", "race_game_start"),
      MPIncidentDefinition("Announce Game Start (Rally)", "rally_game_start"),
      ...
      MPIncidentDefinition("Announce Game Start (CTF)", "ctf_game_start"),
      ...
      MPIncidentDefinition("Announce Game Start (Headhunter)", "headhunter_game_start"),
      ...
      MPIncidentDefinition("Unused", ""),
      MPIncidentDefinition("Announce Game Start (Infection)", "infection_game_start"),
      ...
      MPIncidentDefinition("Announce Game Start (Stockpile)", "stockpile_game_start"),
      MPIncidentDefinition("stock_flags_collected", "stock_flags_collected"),
      MPIncidentDefinition("stock_flag_reset", "stock_flag_reset"),
      MPIncidentDefinition("Announce Game Start (SWAT)", "swat_game_start"),
      MPIncidentDefinition("Announce Game Start (Action Sack)", "action_sack_game_start"),
      MPIncidentDefinition("Announce Game Start (Bumper Cars)", "bumper_cars_game_start"),
      MPIncidentDefinition("custom_game_start", "custom_game_start"),
      MPIncidentDefinition("Announce Game Start (Dogfight)", "dogfight_game_start"),
      MPIncidentDefinition("Announce Game Start (Fiesta)", "fiesta_game_start"),
      MPIncidentDefinition("Announce Game Start (Golf)", "golf_game_start"),
      MPIncidentDefinition("Announce Game Start (Grifball)", "grifball_game_start"),
      MPIncidentDefinition("Announce Game Start (Hogpile)", "hogpile_game_start"),
      MPIncidentDefinition("Announce Game Start (Pinata)", "pinata_game_start"),
      MPIncidentDefinition("Announce Game Start (Soccer)", "soccer_game_start"),
      MPIncidentDefinition("Unused", ""),
      ...
      MPIncidentDefinition("Announce Game Start (Invasion, Spartans)", "invasion_game_start"),
      MPIncidentDefinition("Announce Game Start (Invasion, Elites)", "invasion_game_start_c"),
      ...
      MPIncidentDefinition("Announce Game Start (Invasion Slayer)", "invasion_slayer_start"),
      MPIncidentDefinition("Unused", ""),
