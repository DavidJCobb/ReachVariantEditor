...
namespace Megalo {
   namespace enums {
      auto sound = DetailedEnum({
         DetailedEnumValue("announce_slayer",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/slayer/slayer"),
         ...
         DetailedEnumValue("announce_ctf",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/capture_the_flag/capture_the_flag"),
         ...
         DetailedEnumValue("announce_ctf_captured",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/capture_the_flag/flag_captured"),
         ...
         DetailedEnumValue("announce_ctf_dropped",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/capture_the_flag/flag_dropped"),
         ...
         DetailedEnumValue("announce_ctf_recovered",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/capture_the_flag/flag_recovered"),
         ...
         DetailedEnumValue("announce_ctf_reset",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/capture_the_flag/flag_reset"),
         ...
         DetailedEnumValue("announce_ctf_stolen",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/capture_the_flag/flag_stolen"),
         ...
         DetailedEnumValue("announce_ctf_taken",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/capture_the_flag/flag_taken"),
         ...
         DetailedEnumValue("announce_vip",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/vip/vip"),
         ...
         DetailedEnumValue("announce_vip_new",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/vip/new_vip"),
         ...
         DetailedEnumValue("announce_vip_killed",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/vip/vip_killed"),
         ...
         DetailedEnumValue("announce_juggernaut",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/juggernaut/juggernaut"),
         ...
         DetailedEnumValue("announce_juggernaut_new",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/juggernaut/new_juggernaut"),
         ...
         DetailedEnumValue("announce_territories",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/territories/territories"),
         ...
         DetailedEnumValue("announce_territories_captured",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/territories/territory_captured"),
         ...
         DetailedEnumValue("announce_territories_lost",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/territories/territory_lost"),
         ...
         DetailedEnumValue("announce_assault",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/assault/assault"),
         ...
         DetailedEnumValue("announce_assault_armed",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/assault/bomb_armed"),
         ...
         DetailedEnumValue("announce_assault_detonated",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/assault/bomb_detonated"),
         ...
         DetailedEnumValue("announce_assault_disarmed",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/assault/bomb_disarmed"),
         ...
         DetailedEnumValue("announce_assault_dropped",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/assault/bomb_dropped"),
         ...
         DetailedEnumValue("announce_assault_reset",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/assault/bomb_reset"),
         ...
         DetailedEnumValue("announce_assault_returned",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/assault/bomb_returned"),
         ...
         DetailedEnumValue("announce_assault_taken",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/assault/bomb_taken"),
         ...
         DetailedEnumValue("announce_infection",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/infection/infection"),
         ...
         DetailedEnumValue("announce_infection_infected",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/infection/infected"),
         ...
         DetailedEnumValue("announce_infection_last_man",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/infection/last_man_standing"),
         ...
         DetailedEnumValue("announce_infection_new_zombie",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/infection/new_zombie"),
         ...
         DetailedEnumValue("announce_oddball",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/oddball/oddball"),
         ...
         DetailedEnumValue("announce_oddball_play",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/oddball/play_ball"),
         ...
         DetailedEnumValue("announce_oddball_taken",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/oddball/ball_taken"),
         ...
         DetailedEnumValue("announce_oddball_dropped",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/oddball/ball_dropped"),
         ...
         DetailedEnumValue("announce_oddball_reset",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/oddball/ball_reset"),
         ...
         DetailedEnumValue("announce_koth",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/king_of_the_hill/king_of_the_hill"),
         ...
         DetailedEnumValue("announce_koth_controlled",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/king_of_the_hill/hill_controlled"),
         ...
         DetailedEnumValue("announce_koth_contested",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/king_of_the_hill/hill_contested"),
         ...
         DetailedEnumValue("announce_koth_moved",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/king_of_the_hill/hill_moved"),
         ...
         DetailedEnumValue("announce_headhunter",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/misc/headhunter"),
         ...
         DetailedEnumValue("announce_stockpile",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/misc/stockpile"),
         ...
         DetailedEnumValue("announce_race",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/misc/race"),
         ...
         DetailedEnumValue("announce_defense",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/capture_the_flag/defense"),
         ...
         DetailedEnumValue("announce_offense",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/capture_the_flag/offense"),
            DetailedEnumValueInfo::make_description("Generic announcer dialogue informing the player that they're on Defense this round."),
            DetailedEnumValueInfo::make_subtitle("Offense.")
         ),
         DetailedEnumValue("announce_destination_moved",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/vip/destination_moved"),
         ...
         DetailedEnumValue("announce_sudden_death",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/general/sudden_death"),
         ...
         DetailedEnumValue("announce_game_over",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/general/game_over"),
         ...
         DetailedEnumValue("inv_boneyard_vo_covenant_p3_loss",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/invasion/bone_cv_defeat"),
         ...
         DetailedEnumValue("inv_boneyard_vo_covenant_p1_loss",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/invasion/bone_cv_ph1_defeat"),
         ...
         DetailedEnumValue("inv_boneyard_vo_covenant_p1_intro",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/invasion/bone_cv_ph1_intro"),
         ...
         DetailedEnumValue("inv_boneyard_vo_covenant_p1_win",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/invasion/bone_cv_ph1_victory"),
         ...
         DetailedEnumValue("inv_boneyard_vo_covenant_p2_loss",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/invasion/bone_cv_ph2_defeat"),
         ...
         DetailedEnumValue("inv_boneyard_vo_covenant_p2_win",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/invasion/bone_cv_ph2_victory"),
         ...
         DetailedEnumValue("inv_boneyard_vo_covenant_p3_win",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/invasion/bone_cv_ph3_victory"),
         ...
         DetailedEnumValue("inv_boneyard_vo_covenant_win",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/invasion/bone_cv_victory"),
         ...
         DetailedEnumValue("inv_boneyard_vo_spartan_p3_loss",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/invasion/bone_sp_defeat"),
         ...
         DetailedEnumValue("inv_boneyard_vo_spartan_p1_intro",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/invasion/bone_sp_ph1_intro"),
         ...
         DetailedEnumValue("inv_boneyard_vo_spartan_p1_win",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/invasion/bone_sp_ph1_victory"),
         ...
         DetailedEnumValue("inv_boneyard_vo_spartan_p2_intro",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/invasion/bone_sp_ph2_intro"),
         ...
         DetailedEnumValue("inv_boneyard_vo_spartan_p2_win",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/invasion/bone_sp_ph2_victory"),
         ...
         DetailedEnumValue("inv_boneyard_vo_spartan_p3_intro",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/invasion/bone_sp_ph3_intro"),
         ...
         DetailedEnumValue("inv_boneyard_vo_spartan_p3_win",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/invasion/bone_sp_ph3_victory"),
         ...
         DetailedEnumValue("inv_spire_vo_covenant_loss",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/invasion/isle_cv_defeat"),
         ...
         DetailedEnumValue("inv_spire_vo_covenant_p1_win",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/invasion/isle_cv_ph1_victory"),
            DetailedEnumValueInfo::make_description("Voiceover for the Covenant played upon winning Phase 1."),
         ...
         DetailedEnumValue("inv_spire_vo_covenant_p1_intro",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/invasion/isle_cv_ph1_intro"),
            DetailedEnumValueInfo::make_description("Voiceover for the Covenant played at the start of Phase 1."),
         ...
         DetailedEnumValue("inv_spire_vo_covenant_p2_intro",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/invasion/isle_cv_ph2_intro"),
         ...
         DetailedEnumValue("inv_spire_vo_covenant_p2_win",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/invasion/isle_cv_ph2_victory"),
            DetailedEnumValueInfo::make_description("Voiceover for the Covenant played upon winning Phase 2."),
         ...
         DetailedEnumValue("inv_spire_vo_covenant_p3_intro",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/invasion/isle_cv_ph3_intro"),
         ...
         DetailedEnumValue("inv_spire_vo_covenant_p3_win",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/invasion/isle_cv_ph3_victory"),
            DetailedEnumValueInfo::make_description("Voiceover for the Covenant played upon winning Phase 3."),
         ...
         DetailedEnumValue("inv_spire_vo_spartan_p3_loss",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/invasion/isle_sp_defeat"),
         ...
         DetailedEnumValue("inv_spire_vo_spartan_p1_loss",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/invasion/isle_sp_ph1_defeat"),
         ...
         DetailedEnumValue("inv_spire_vo_spartan_p1_extra",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/invasion/isle_sp_ph1_extra"),
         ...
         DetailedEnumValue("inv_spire_vo_spartan_p1_intro",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/invasion/isle_sp_ph1_intro"),
            DetailedEnumValueInfo::make_description("Voiceover for the Spartans played at the start of Phase 1."),
         ...
         DetailedEnumValue("inv_spire_vo_spartan_p1_win",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/invasion/isle_sp_ph1_victory"),
            DetailedEnumValueInfo::make_description("Voiceover for the Spartans played upon winning Phase 1."),
         ...
         DetailedEnumValue("inv_spire_vo_spartan_p2_loss",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/invasion/isle_sp_ph2_defeat"),
         ...
         DetailedEnumValue("inv_spire_vo_spartan_p2_win",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/invasion/isle_sp_ph2_victory"),
            DetailedEnumValueInfo::make_description("Voiceover for the Spartans played upon winning Phase 2."),
         ...
         DetailedEnumValue("inv_spire_vo_spartan_p3_win",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/invasion/isle_sp_ph3_victory"),
         ...
         DetailedEnumValue("inv_spire_vo_spartan_win",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/invasion/isle_sp_victory"),
            DetailedEnumValueInfo::make_description("Voiceover for the Spartans played upon winning Phase 3."),
         ...
         DetailedEnumValue("inv_cue_covenant_win_big",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/music/invasion_temp_cues/covy_big_win"),
         ...
         DetailedEnumValue("inv_cue_covenant_win_1",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/music/invasion_temp_cues/covy_win1"),
         ...
         DetailedEnumValue("inv_cue_covenant_win_2",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/music/invasion_temp_cues/covy_win2"),
         ...
         DetailedEnumValue("inv_cue_spartan_win_big",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/music/invasion_temp_cues/unsc_big_win"),
         ...
         DetailedEnumValue("inv_cue_spartan_win_1",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/music/invasion_temp_cues/unsc_win1"),
         ...
         DetailedEnumValue("inv_cue_spartan_win_2",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/music/invasion_temp_cues/unsc_win2"),
         ...
         DetailedEnumValue("boneyard_generator_power_down",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/device_machines/omaha/boneyard_generator_power_down"),
         ...
         DetailedEnumValue("firefight_lives_added",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/firefight/survival_awarded_lives"),
         ...
         DetailedEnumValue("timer_beep",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/game_sfx/multiplayer/player_timer_beep"),
            DetailedEnumValueInfo::make_description("The beep used for the respawn timer.")
         ),
         DetailedEnumValue("announce_a_under_attack",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/reach/firefight/alpha_under_attack"),
         ...
         DetailedEnumValue("announce_b_under_attack",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/reach/firefight/bravo_under_attack"),
         ...
         DetailedEnumValue("announce_c_under_attack",
            DetailedEnumValueInfo::make_map_tag('snd!', "sound/dialog/multiplayer/reach/firefight/charlie_under_attack"),
   ...
   arg_compile_result OpcodeArgValueSound::compile(Compiler& compiler, cobb::string_scanner& arg, uint8_t part) noexcept {
      if (part > 0)
      ...
      int32_t value = 0;
      QString word;
      auto    result = compiler.try_get_integer_or_word(arg, value, word, QString("sound names"), nullptr, max_value);
