...
namespace Megalo {
   namespace variable_scope_indicators {
      namespace timer {
         ...
         extern VariableScopeIndicatorValue round_timer        = VariableScopeIndicatorValue::make_game_value("game.round_timer",        "Round Timer",        VariableScopeIndicatorValue::flags::is_readonly);
         extern VariableScopeIndicatorValue sudden_death_timer = VariableScopeIndicatorValue::make_game_value("game.sudden_death_timer", "Sudden Death Timer", VariableScopeIndicatorValue::flags::is_readonly);
         extern VariableScopeIndicatorValue grace_period_timer = VariableScopeIndicatorValue::make_game_value("game.grace_period_timer", "Grace Period Timer", VariableScopeIndicatorValue::flags::is_readonly);
      }
   }
