      ...
      namespace enums {
         auto sound = DetailedEnum({
            ...
            DetailedEnumValue("inv_boneyard_vo_covenant_win",
               ...
               DetailedEnumValueInfo::make_description("Voiceover for the Covenant played upon winning the match.")
            ),
            ...
            DetailedEnumValue("inv_spire_vo_spartan_p1_extra",
               ...
               DetailedEnumValueInfo::make_description("Voiceover for the Spartans played during Phase 1.")
            ),
            ...
            DetailedEnumValue("inv_spire_vo_spartan_win",
               ...
               DetailedEnumValueInfo::make_description("Voiceover for the Spartans played upon winning the match.")
            ),
            DetailedEnumValue("inv_spire_vo_spartan_p3_loss",
               DetailedEnumValueInfo::make_map_tag('mgls', "sound/dialog/invasion/isle_sp_ph3_defeat"),
               DetailedEnumValueInfo::make_description("Voiceover for the Spartans played when the match is lost during Phase 3.")
            ),
            ...
            DetailedEnumValue("inv_cue_covenant_win_big",
               DetailedEnumValueInfo::make_map_tag('mgls', "sound/dialog/invasion_temp_cues/covy_big_win"),
               DetailedEnumValueInfo::make_description("")
            ),
            DetailedEnumValue("inv_cue_covenant_win_1",
               DetailedEnumValueInfo::make_map_tag('mgls', "sound/dialog/invasion_temp_cues/covy_win1"),
               DetailedEnumValueInfo::make_description("")
            ),
            DetailedEnumValue("inv_cue_covenant_win_2",
               DetailedEnumValueInfo::make_map_tag('mgls', "sound/dialog/invasion_temp_cues/covy_win2"),
               DetailedEnumValueInfo::make_description("")
            ),
            ...
            DetailedEnumValue("inv_cue_spartan_win_big",
               DetailedEnumValueInfo::make_map_tag('mgls', "sound/dialog/invasion_temp_cues/unsc_big_win"),
               DetailedEnumValueInfo::make_description("")
            ),
            DetailedEnumValue("inv_cue_spartan_win_1",
               DetailedEnumValueInfo::make_map_tag('mgls', "sound/dialog/invasion_temp_cues/unsc_win1"),
               DetailedEnumValueInfo::make_description("")
            ),
            DetailedEnumValue("inv_cue_spartan_win_2",
               DetailedEnumValueInfo::make_map_tag('mgls', "sound/dialog/invasion_temp_cues/unsc_win2"),
               DetailedEnumValueInfo::make_description("")
            ),
