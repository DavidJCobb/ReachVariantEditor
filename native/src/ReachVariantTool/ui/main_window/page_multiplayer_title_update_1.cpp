...
PageMPTU1Config::PageMPTU1Config(QWidget* parent) : QWidget(parent) {
   ...
   reach_main_window_setup_flag_checkbox(this->ui.fieldBleedthrough,              titleUpdateData.flags, ReachTU1Flags::enable_bleed_through);
   reach_main_window_setup_flag_checkbox(this->ui.fieldArmorLockCantShed,         titleUpdateData.flags, ReachTU1Flags::armor_lock_cant_shed_stickies);
   reach_main_window_setup_flag_checkbox(this->ui.fieldArmorLockCanBeStuck,       titleUpdateData.flags, ReachTU1Flags::armor_lock_can_be_stuck);
   reach_main_window_setup_flag_checkbox(this->ui.fieldEnableActiveCamoModifiers, titleUpdateData.flags, ReachTU1Flags::enable_active_camo_modifiers);
   reach_main_window_setup_flag_checkbox(this->ui.fieldLimitSwordBlockToSword,    titleUpdateData.flags, ReachTU1Flags::limit_sword_block_to_sword);
   reach_main_window_setup_flag_checkbox(this->ui.fieldAutomaticMagnum,           titleUpdateData.flags, ReachTU1Flags::enable_automatic_magnum);
   {  // Precision Bloom
