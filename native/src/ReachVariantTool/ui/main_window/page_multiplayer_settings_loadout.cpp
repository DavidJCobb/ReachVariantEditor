...
PageMPSettingsLoadoutsOverall::PageMPSettingsLoadoutsOverall(QWidget* parent) : QWidget(parent) {
   ...
   reach_main_window_setup_cg_flag_checkbox(this->ui.fieldFlag0, loadouts.flags, 0x01);
   reach_main_window_setup_cg_flag_checkbox(this->ui.fieldFlag1, loadouts.flags, 0x02);
