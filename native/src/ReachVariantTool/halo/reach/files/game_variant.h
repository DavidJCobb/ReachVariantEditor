...
#include <optional>
#include <vector>
#include "./blocks/blam_header.h"
#include "./blocks/author_header.h"
#include "./blocks/content_header.h"
#include "./blocks/eof_block.h"
#include "./blocks/unknown_file_block.h"
